...
a = AIAgent(api_key='offline-fixture', base_url='http://127.0.0.1:9/v1', provider='custom', model='offline-test', enabled_toolsets=[], quiet_mode=True, skip_context_files=True, skip_memory=True, save_trajectories=False)
...
print(json.dumps({'provider_writers':usage_rows}),flush=True)
