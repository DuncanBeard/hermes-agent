...
// Presentation metadata for the built-in inference accounts. Provider identity
// and available key fields are supplied by the backend catalog.
...
export const PROVIDER_GROUPS: ProviderPrefix[] = [
  ...
  },
  {
    ...
    name: 'GitHub Copilot',
    priority: 1,
    description: 'Direct GitHub Copilot API access',
